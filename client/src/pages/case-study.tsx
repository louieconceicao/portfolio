...
import connectorImage from "@assets/stock_images/salesforce-logisense-erd.png";
import wireframeImage from "@assets/stock_images/salesforce-logisense-erd.png";
  ...
  return (
    <div className="min-h-screen bg-background text-foreground font-sans pb-32">
        ...
        >
          ...
          <div className="flex flex-wrap gap-2 mb-12">
            {project.tags.map(tag => (
              <span key={tag} className="text-sm text-neutral-600 border border-neutral-300 px-4 py-1.5 rounded-full">
                {tag}
              </span>
            ))}
          </div>
      ...
      <main className="max-w-4xl mx-auto px-6 lg:px-12 space-y-24">
        ...
        {/* Challenge */}
        <section>
          <h2 className="text-sm font-medium text-neutral-500 tracking-wide uppercase mb-6">The Challenge</h2>
        ...
        <section className="grid lg:grid-cols-12 gap-12 border-t border-neutral-200 pt-20">
          <div className="lg:col-span-4">
             <h2 className="text-sm font-medium text-neutral-500 tracking-wide uppercase mb-6">The Approach</h2>
          </div>
          <div className="lg:col-span-8">
            <ul className="space-y-6">
              {project.approach.map((item, i) => (
                <li key={i} className="flex gap-6 items-start group">
                  <span className="text-neutral-300 font-light text-xl group-hover:text-neutral-900 transition-colors">0{i + 1}</span>
        ...
        <section className="grid lg:grid-cols-12 gap-12">
          <div className="lg:col-span-4">
             <h2 className="text-sm font-medium text-neutral-500 tracking-wide uppercase mb-6">The Results</h2>
          </div>
          <div className="lg:col-span-8">
             <div className="grid gap-8">
              {project.results.map((item, i) => (
                <div key={i} className="border-l-2 border-neutral-200 pl-6 py-2">
                  <p className="text-xl text-neutral-800 font-light">
                    {item}
                  </p>
                </div>
              ))}
